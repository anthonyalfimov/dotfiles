" Based on the Airline default "dark" theme and inspired by the "gruvbox" theme
" by morhetz: https://github.com/morhetz/gruvbox
"
" dark.vim original copyright:
...
"
" For this, the darkbox.vim, theme, this is defined as
let g:airline#themes#darkbox#palette = {}

" Keys in the dictionary are composed of the mode, and if specified the
" override.  For example:
"   * g:airline#themes#darkbox#palette.normal
"       * the colors for a statusline while in normal mode
"   * g:airline#themes#darkbox#palette.normal_modified
"       * the colors for a statusline while in normal mode when the buffer has
"         been modified
"   * g:airline#themes#darkbox#palette.visual
...
" let g:airline#themes#darkbox#palette.normal = airline#themes#generate_color_map(
...
" let g:airline#themes#darkbox#palette.normal = {
...
" applied after g:airline#themes#darkbox#palette.normal, hence why only certain keys are
" declared.
let g:airline#themes#darkbox#palette.normal_modified = {
      \ 'airline_c': [ '#fe8019' , '#202020' , 208 , 234      , ''     ] ,
      \ }


let s:airline_a_insert = [ '#282828' , '#83a598' , 235 , 153 ]
let s:airline_b_insert = [ '#ffffff' , '#458588' , 255 , 67  ]
let s:airline_c_insert = [ '#d7ffd7' , '#202020' , 194 , 234 ]
let g:airline#themes#darkbox#palette.insert = airline#themes#generate_color_map(s:airline_a_insert, s:airline_b_insert, s:airline_c_insert)
let g:airline#themes#darkbox#palette.insert_modified = {
      \ 'airline_c': [ '#fe8019' , '#202020' , 208 , 234     , ''     ] ,
      \ }
let g:airline#themes#darkbox#palette.insert_paste = {
      \ 'airline_a': [ s:airline_a_insert[0]   , '#d3869b' , s:airline_a_insert[2] , 175     , ''     ] ,
      \ }

let s:airline_a_replace = [ '#282828' , '#fb4934' , 235 , 209 ]
let s:airline_b_replace = [ '#ffffff' , '#cc241d' , 255 , 88  ]
let s:airline_c_replace = [ '#d7ffd7' , '#202020' , 194 , 234 ]
let g:airline#themes#darkbox#palette.replace = airline#themes#generate_color_map(s:airline_a_replace, s:airline_b_replace, s:airline_c_replace)
let g:airline#themes#darkbox#palette.replace_modified = {
      \ 'airline_c': [ '#fe8019' , '#202020' , 208 , 234     , ''     ] ,
      \ }

let s:airline_a_visual = [ '#282828' , '#fabd2f' , 235 , 214 ]
let s:airline_b_visual = [ '#ffffff' , '#d79921' , 255 , 130 ]
let s:airline_c_visual = [ '#d7ffd7' , '#202020' , 194 , 234 ]
let g:airline#themes#darkbox#palette.visual = airline#themes#generate_color_map(s:airline_a_visual, s:airline_b_visual, s:airline_c_visual)
let g:airline#themes#darkbox#palette.visual_modified = {
      \ 'airline_c': [ '#fe8019' , '#202020' , 208 , 234     , ''     ] ,
      \ }
...
let g:airline#themes#darkbox#palette.inactive = airline#themes#generate_color_map(s:airline_a_inactive, s:airline_b_inactive, s:airline_c_inactive)
let g:airline#themes#darkbox#palette.inactive_modified = {
      \ 'airline_c': [ '#d65d0e' , '' , 166 , '' , '' ] ,
      \ }
...
let g:airline#themes#darkbox#palette.accents = {
      \ 'red': [ '#ff0000' , '' , 160 , ''  ]
      \ }
...
if get(g:, 'loaded_ctrlp', 0)
  let g:airline#themes#darkbox#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
